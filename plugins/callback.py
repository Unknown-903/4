...
async def donatecm(bot,message):
    ...
    keybord = InlineKeyboardMarkup([
        [InlineKeyboardButton("🦋 Admin",url = "https://t.me/+5AlBIyGcgWkwYmRl"),
...
async def home_callback_handler(bot, query):
    ...
    keybord = InlineKeyboardMarkup([  
                    [InlineKeyboardButton("📢 Updates", url="https://t.me/Bash_X_Bots"),
                    InlineKeyboardButton("💬 Support", url="https://t.me/+5AlBIyGcgWkwYmRl")],
                    [InlineKeyboardButton("🛠️ Help", callback_data='help'),
		            InlineKeyboardButton("❤️‍🩹 About", callback_data='about')],
                    [InlineKeyboardButton("🧑‍💻 Developer 🧑‍💻", url="https://t.me/+5AlBIyGcgWkwYmRl")]
		  ])
